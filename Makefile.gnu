test:
	...
	gfortran -g -o test tetrahedron_keast_rule.o triangle_fekete_rule.o PROBCOMMON.o GLOBALUTIL.o MOF.o BICGSTAB_Yang_MULTI.o vof_cisl.o vfrac_pair.o multimat_FVM.o main.o
