...
real(kind=8),parameter :: radeps=0.05d0 ! thick:0.1d0  thin:0.005d0
real(kind=8),parameter :: thermal_delta= 0.01d0  ! prhobtype=6 thickness of the thermal layer
integer,parameter      :: refine_lev = 6
